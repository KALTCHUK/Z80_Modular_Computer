...
; 30/08/21 - version E is a test for the new serial card (preTTY). It only
;            changes the CONST, CONIN and CONOUT BIOS functions, and removes
;            all those unnecessary routines related to USART (8251).
;==================================================================================
#INCLUDE	"equates.h"
...
; preTTY card stuff
TTY_ADDR		.EQU	0C0H			; preTTY card main addr
TTY_DAT			.EQU	TTY_ADDR		; addr for data read/write
TTY_STA			.EQU	TTY_ADDR+2		; addr for status read
...
boot:
		...
		CALL	PRINTSEQ
		.DB CR,LF,"Z80 Modular Computer by Kaltchuk 2021.",CR,LF
		.DB "BIOS 1.0E - 128MB Compact Flash, preTTY.",CR,LF
...
CONIN:	IN	A,(TTY_STA)
		CP	0
		JR	Z,CONIN			; Keep trying till we receive something
		IN	A,(TTY_DAT)
