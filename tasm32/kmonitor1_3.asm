...
;Monitor 1.3: Modified to use VT100 terminal ("ESC[xx" commands). Must use with updated BIOS (kbios128v1_1)
;
;==================================================================================
...
MONITOR:
		CALL	PRINTSEQ
		.TEXT	"Z80 Modular Computer Monitor V1.3 by Kaltchuk, Sep/2020"
		.DB	CR,LF,CR,LF,0
CMDLIST:
		CALL	PRINTSEQ
		.TEXT	"Valid commands:"
