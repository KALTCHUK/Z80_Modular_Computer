...
const byte ledPin = 13, dePin = 11, initPin = 12, sensorPin = A0;
const word bufSize = 256, numCoils = 1, numHoldingRegisters = 2, numInputRegisters = 1, sensorAddress = 0, ledAddress = 0;
