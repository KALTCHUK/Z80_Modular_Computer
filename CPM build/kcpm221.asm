...
;*
;*             C P / M   version   2 . 2 1
;* This version has a new built-in command - TPA, which executes
;*  a jump to TPA (0100h). This allows us to download a program
;*  with the Monitor xmodem command, reboot to CP/M and run the
;*       program from memory. No need to fetch from disk.
;*
